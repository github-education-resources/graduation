...
Replace `<YOUR-USERNAME>.md` with your GitHub username in this guide.

## 1. Create the folder _data/YOUR-USERNAME/ 
Fork this repository, create a new folder inside the `_data` folder, and name it with your username. It should look something like this `_data/<YOUR-USERNAME>.md/`. Ex.
...
Create a markdown file in your folder following the convention `<YOUR-USERNAME>.md.md`. Ex.
